...
const RATOON_STEP = {
  ...
  content: [
    'ตัดแต่งตออ้อยหลังจากตัดทันทีหรือภายใน 15 วัน',
    'สับให้ติดดินเพื่อบังคับให้หน่อที่จะเกิดใหม่เกิดจากตอใต้ดิน',
    'ส่งผลให้อ้อยขึ้นสม่ำเสมอ หน่ออ้อยแข็งแรง สมบูรณ์ได้น้ำหนักตันอ้อยมาก',
    'หากตัดอ้อยชิดดินก็ไม่ต้องตัดแต่งตออ้อย',
    'เก็บตอได้ 3 ปี ต้นทุนการปลูกลดลง 30-40%',
  ],
  tips: 'ต้นทุนของเก็บตอลดลง 30-40% เทียบกับปลูกใหม่ แต่ผลผลิตยังคงที่ดี',
};
